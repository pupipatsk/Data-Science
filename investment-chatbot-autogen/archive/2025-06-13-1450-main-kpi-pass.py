...
class InvestmentAnalysis(BaseModel):
    ...
    relevant_kpis: List[RelevantKPI] = Field(
        description="List of relevant KPIs with individual ratings"
    )
...
class AutogenStructuredOutput:
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        analyst = AssistantAgent(
            ...
            Your task is to analyze the stock with ticker {
                self.ticker
            ...
            Your response must be a valid JSON object that strictly follows the InvestmentAnalysis schema below. 
        ...
        try:
            ...
            print(
                f"  • relevant_kpis: {'✓' if 'relevant_kpis' in analysis_dict else '✗'}"
            )
            print(
                f"  • improvement_requirements: {'✓' if 'improvement_requirements' in analysis_dict else '✗'}"
            )
...
if __name__ == "__main__":
    ...
    new_input_data = {
        ...
        "framework": "autogen",
        "llm_provider": "gemini",
        "workflow_input_data": {"ticker": "AAPL"},
    }
